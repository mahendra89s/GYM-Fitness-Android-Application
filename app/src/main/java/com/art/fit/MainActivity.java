...
public class MainActivity extends AppCompatActivity implements SensorEventListener {
    ...
    TextView tv_steps;
    Button btnadd,btnremove,btn_reset,btn_train,weight_track,diet;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_train = findViewById(R.id.button);
        distance= findViewById(R.id.tv_steps2);
        water= findViewById(R.id.textView2);
        diet = findViewById(R.id.diet);
        weight_track = findViewById(R.id.weight_track);
        ...
        weight_track.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View v) {
                        Intent intent;
                        intent = new Intent(getApplicationContext(),weighttrack.class);
                        startActivity(intent);
                    }
                }
        );
    ...
    public void onSensorChanged(SensorEvent Event) {
        ...
        if(running)
        {
            ...
            distance.setText(String.valueOf(String.format("%.2f",(c*0.76))));
            calorie.setText(String.valueOf(String.format("%.2f",(c*.05))));
